...
public interface OrderDao extends PagingAndSortingRepository<Order, Long>,
	...
	Page<Order> findByNameStartsWithAndStatusIn(String name,
			List<String> statuses, Pageable pageable);

	Page<Order> findByStatusStartsWithAndStatusIn(String status,
			List<String> statuses, Pageable pageable);

	Page<Order> findByStatusIn(List<String> statuses, Pageable pageable);

	Page<Order> findByStatusInAndIdIs(List<String> statuses, Long id,
			Pageable pageable);
