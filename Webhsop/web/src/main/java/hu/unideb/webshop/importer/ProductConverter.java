...
@FacesConverter("productConverterOfImporterNecessaryProducts")
public class ProductConverter implements Serializable, Converter {
	...
	public Object getAsObject(FacesContext arg0, UIComponent arg1, String value) {
		...
		ImporterNecessaryProducts viewScopedBean = (ImporterNecessaryProducts) viewMap
				.get("importerNecessaryProducts");
